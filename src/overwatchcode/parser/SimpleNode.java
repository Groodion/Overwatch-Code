...
class SimpleNode implements Node {
  ...
  public SimpleNode(OWCParser p, int i) {
    this(i);
    parser = p;
  }
  ...
  public overwatchcode.workshop.Block jjtAccept(OWCParserVisitor visitor, overwatchcode.workshop.Block data)
{
  ...
  /** Accept the visitor. **/
  public Object childrenAccept(OWCParserVisitor visitor, overwatchcode.workshop.Block data)
{
    if (children != null) {
  ...
  public String toString() { return OWCParserTreeConstants.jjtNodeName[id]; }
...
/* JavaCC - OriginalChecksum=33ad6080935489651871848bdc3b0561 (do not edit this line) */
