...
public
class ASTLineStatement extends SimpleNode {
  public ASTLineStatement(int id) {
    super(id);
  }

  public ASTLineStatement(OWCParser p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=e127cf54c14478158feeed32c660e176 (do not edit this line) */
